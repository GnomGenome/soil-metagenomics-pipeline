...
echo "[INFO] Работа METABAT2 успешно завершена..."
mamba deactivate
...
echo "[INFO] Работа MAXBIN успешно завершена..."
mamba deactivate
...
/home/k/miniforge3/pkgs/das_tool-1.1.7-r43hdfd78af_0/share/das_tool-1.1.7-0/src/Fasta_to_Contig2Bin.sh -i "${CONCOCT_DIR}/bins/fasta_bins" -e fa > "${DAS_TOOL_OUTPUT}/concoct.contigs2bin.tsv"
/home/k/miniforge3/pkgs/das_tool-1.1.7-r43hdfd78af_0/share/das_tool-1.1.7-0/src/Fasta_to_Contig2Bin.sh -i "${METABAT_DIR}/bins/" -e fa > "${DAS_TOOL_OUTPUT}/metabat.contigs2bin.tsv"
